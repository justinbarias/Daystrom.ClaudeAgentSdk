...
namespace Anthropic.ClaudeAgentSdk.Tests.Sandbox;
...
public class SandboxXmlDocCaveatTest
{
    ...
    {
        var assembly = typeof(Anthropic.ClaudeAgentSdk.Sandbox.SandboxSettings).Assembly;
        ...
        var member = doc.Descendants("member")
            .FirstOrDefault(m =>
                (string?)m.Attribute("name") == "T:Anthropic.ClaudeAgentSdk.Sandbox.SandboxSettings"
            );
