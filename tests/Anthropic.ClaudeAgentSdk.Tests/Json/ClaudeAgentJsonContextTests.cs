...
using ThinkingConfigBase = Anthropic.ClaudeAgentSdk.ThinkingConfig.ThinkingConfig;
using ThinkingConfigEnabled = Anthropic.ClaudeAgentSdk.ThinkingConfig.ThinkingConfigEnabled;
