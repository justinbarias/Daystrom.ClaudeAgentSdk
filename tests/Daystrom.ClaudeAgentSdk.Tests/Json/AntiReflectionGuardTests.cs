...
public class AntiReflectionGuardTests
{
    ...
    private static string LocateSdkSource()
    {
        ...
        // the repo's `src/Daystrom.ClaudeAgentSdk` folder. Walking the
        ...
        {
            var candidate = Path.Combine(dir.FullName, "src", "Daystrom.ClaudeAgentSdk");
        ...
        throw new DirectoryNotFoundException(
            "Could not locate src/Daystrom.ClaudeAgentSdk relative to the test assembly."
        );
    }
